...
return new class extends Migration
{
    ...
    {
        DB::unprepared("
            IF OBJECT_ID('usp_app_AllBill', 'P') IS NOT NULL
            BEGIN
                DROP PROCEDURE usp_app_AllBill;
            END
        ");

        DB::unprepared("
            create proc [dbo].[usp_app_AllBill]   
            ...
            If @Count>0    
            Begin    
            Select BD.BillDetailID AS ID,(N'Dr. ' + EM.FirstName + ' ' + EM.MiddleName + ' ' + EM.LastName) AS DoctorName  

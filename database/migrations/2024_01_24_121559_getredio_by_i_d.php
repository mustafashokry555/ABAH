...
return new class extends Migration
{
    ...
    {
        DB::unprepared("
            IF OBJECT_ID('usp_app_apiGetRadioID', 'P') IS NOT NULL
            BEGIN
                DROP PROCEDURE usp_app_apiGetRadioID;
            END
        ");

        DB::unprepared("
            create proc [dbo].[usp_app_apiGetRadioID]
            @OrderId as Int
            ...
            inner join hospital_mst HM on P.Hospital_ID=HM.Hospital_ID  where Od.OrdDtlID=@OrderId
